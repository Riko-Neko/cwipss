...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--cprf-threshold-snr", type=float, default=None, help="CPRF absolute CWT normalization floor.")
    parser.add_argument("--cprf-texture-quantile", type=float, default=None, help="CPRF absolute CWT texture quantile.")
    parser.add_argument("--cprf-min-band-concentration", type=float, default=None, help="Minimum CPRF main-band concentration.")
    parser.add_argument("--cprf-min-local-contrast", type=float, default=None, help="Minimum CPRF local sideband contrast.")
    parser.add_argument("--cprf-min-integrated-strength", type=float, default=None, help="Minimum CPRF integrated strength.")
