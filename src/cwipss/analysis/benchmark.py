...
def run_cwt_candidate_search(
    ...
    CPROParameters(
        ...
        shape_occupancy_softness=search_config.cpro_shape_occupancy_softness,
        shape_top_k=search_config.cpro_shape_top_k,
    ).validate()
    ...
    try:
        for block_index, block_start in enumerate(range(0, matrix.shape[1], search_config.block_channels), start=1):
            ...
            candidates, windows = detector(
                ...
                cpro_shape_occupancy_softness=search_config.cpro_shape_occupancy_softness,
                cpro_shape_top_k=search_config.cpro_shape_top_k,
